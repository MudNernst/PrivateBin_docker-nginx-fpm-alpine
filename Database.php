...
class Database extends AbstractData
{
    ...
    public static function getInstance(array $options)
    {
        ...
        if (
            ...
            // MySQL定制化
            if (self::$_type === 'mysql') {
                $options['opt'][PDO::MYSQL_ATTR_USE_BUFFERED_QUERY] = true;
            }
    ...
    private static function _createCommentTable()
    {
        ...
        // MySQL定制化
        $indexCreateSql = 'CREATE INDEX IF NOT EXISTS comment_parent ON ';
        if (self::$_type === 'mysql') {
            $indexCreateSql = 'CREATE INDEX comment_parent ON ';
        }
        self::$_db->exec(
            "$indexCreateSql " .
